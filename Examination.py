...
class CheckingFile:
    def __init__(self, file_name):
        ...
        self.expected_columns = ["Участники гражданского оборота", "Тип операции", "Сумма операции",
                                "Вид расчета", "Место оплаты", "Терминал оплаты", "Дата оплаты",
                                "Время оплаты", "Результат операции", "Cash-back", "Сумма cash-back"]
      
        self.expected_types = {"Участники гражданского оборота": object, "Тип операции": object,
                                "Сумма операции": float, "Вид расчета": object, "Место оплаты": object, 
                                "Терминал оплаты": object, "Дата оплаты": object, "Время оплаты": object,
                                "Результат операции": object, "Cash-back": object,"Сумма cash-back": float }
 
    def research_file(self):
        try:
            if not os.path.exists(self.file_name):
                raise FileNotFoundError(f'Ошибка: файл {self.file_name} не существует.')
